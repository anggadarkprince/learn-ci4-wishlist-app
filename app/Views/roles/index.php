        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="#modal-filter" data-toggle="modal" class="btn btn-outline-primary">
                            <i class="mdi mdi-filter-variant mr-0"></i>
                        </a>
                        <a href="<?= base_url(uri_string()) ?>?<?= $_SERVER['QUERY_STRING'] ?>&export=true" class="btn btn-outline-primary">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item btn-delete" href="#modal-delete" data-toggle="modal"
                                           ...
                                           data-url="<?= site_url('master/roles/' . $role->id) ?>">
