                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <td>
                                    <i class="mdi mdi-arrow-up text-success mr-3"></i> 46,53%
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <i class="mdi mdi-arrow-down text-warning mr-3"></i> 46,53%
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <i class="mdi mdi-arrow-down text-warning mr-3"></i> 36,49%
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <i class="mdi mdi-arrow-up text-success mr-3"></i> 50,87%
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <i class="mdi mdi-arrow-down text-danger mr-3"></i> 46,53%
                                </td>
                            </tr>
                            </tbody>
                        </table>
