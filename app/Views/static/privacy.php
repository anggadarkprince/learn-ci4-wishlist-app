...
<?= $this->section('content') ?>
        <div class="card grid-margin">
            <div class="card-body">
                <h2 class="card-title">Agreement & Privacy</h2>
                <h3>Terms and Conditions</h3>
                <p class="text-muted">Last updated: October 20, 2018</p>
                <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the <?= config( 'App')->appName ?>
                    website (the "Service") operated by <?= config( 'App')->appName ?> ("us", "we", or "our").</p>
                ...
                <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms
                    ...
                    <a href="https://termsfeed.com" rel="nofollow">TermsFeed</a> for <?= config( 'App')->appName ?>.</p>
                ...
                <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by
                    <?= config( 'App')->appName ?>.</p>

                <p><?= config( 'App')->appName ?> has no control over, and assumes no responsibility for, the content, privacy policies, or practices of
                    any third party web sites or services. You further acknowledge and agree that <?= config( 'App')->appName ?> shall not be responsible or
