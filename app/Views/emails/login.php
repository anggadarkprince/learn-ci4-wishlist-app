                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="570"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">Password Recovered</h1>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        ...
                                        <b>Username:</b> <?= $loginData['username'] ?><br>
                                        <b>Email:</b> <?= $loginData['email'] ?><br>
                                        <b>IP Address:</b> <?= $loginData['platform'] ?><br>
                                        <b>Browser:</b> <?= $loginData['browser'] ?><br><br>
                                        <b>Is Mobile:</b> <?= $loginData['is_mobile'] ? 'YES' : 'NO' ?><br><br>
                                        <b>If this activity is not yours then contact our support.</b>
                                    </p>
                                        ...
                                        <tr>
                                            <td style="<?php echo $fontFamily ?>">
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    ...
                                                    <a href="mailto:<?= $loginData['email'] ?>" style="<?php echo $style['anchor'] ?>">
                                                        <?= $loginData['email'] ?>
                                                    </a>
                                                </p>
                                            </td>
