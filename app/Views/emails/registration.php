                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="570"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">One Step Closer</h1>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Welcome to wishlist app, we hope you find joy with our service. Please click
                                        button bellow to activate your account, so you can access our full features.
                                        If you think something wrong happen here please contact our
                                        <a href="mailto:<?= config( 'App')->appEmail ?>">support</a>
                                    </p>
                                    ...
                                    <table style="<?php echo $style['body_action'] ?>" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="<?php echo site_url('register/confirm/' . $token); ?>"
                                            ...
                                            <td style="<?php echo $fontFamily ?>">
                                                ...
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    <a style="<?php echo $style['anchor'] ?>"
                                                       href="<?= site_url('register/confirm/' . $token); ?>"
                                                       target="_blank">
                                                        <?= site_url('register/confirm/' . $token) ?>
                                                    </a>
                                                </p>
